...
class Program
{
    ...
    {
        var Person1 = new Person("MaximHarry", "Potter", DateTime.Now);
        var Person2 = new Person("William", "Smith", DateTime.Now);
        ...
        student.Exam = new Exam[] { new Exam("astronomy", 4, date3) };
        student.Group = 10;

        student.AddExams(new Exam("geography", 3, date1), new Exam("ecology", 5, date2));

        student2.AddExams(new Exam("computer science", 5, date1), new Exam("chemistry", 5, date2));
